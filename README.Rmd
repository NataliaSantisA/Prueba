...
Launch the [`make.R`](https://github.com/NataliaSantisA/Prueba/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/NataliaSantisA/Prueba/blob/main/CONTRIBUTING.md).
